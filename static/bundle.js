...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "</h1>\n\n<ul>\n  ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.goals), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
...
},{"backbone":17,"views/chapter":10,"views/examples":11,"views/references":14,"views/welcome":16}],13:[function(require,module,exports){
var Backbone = require('backbone');
